...
public class ExtendedEnchantments implements ModInitializer {
	...
	public static final Logger LOGGER = LogManager.getLogger("extendedenchantments");

	// what's the point of assigning if we're not using it...?
	...
	public void onInitialize() {
		...
		LOGGER.info("Hello Fabric world from Extended Enchantments!");
	}
}
